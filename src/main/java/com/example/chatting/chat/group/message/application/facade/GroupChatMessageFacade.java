...
public class GroupChatMessageFacade {
    ...
    private final GroupChatMessageEventPublisher groupChatMessageEventPublisher;
    ...
    public void createGroupChatMessage(long roomId, long senderId, String content){
        ...
        groupChatMessageEventPublisher.publishGroupChatMessageEvent(groupChatMessageEvent);
    }
